...
# Make Deb Package for TechRuchin (^.^)
_PACKAGE=TechRuchin
_VERSION=2.3.5
_ARCH="all"
...
Maintainer: @htr-tech
Depends: ${_depend}
Homepage: https://github.com/RuchinHimasha/TechRuchin
...
cp -fr .github/ .sites/ LICENSE README.md TechRuchin.sh ./build_env/$_opt_dir
