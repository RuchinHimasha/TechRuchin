...
banner() {
	cat <<- EOF
		${ORANGE}
		${ORANGE} _____            _       ____                _      _        
		${ORANGE}|_   _|___   ___ | |__   |  _ \  _   _   ___ | |__  (_) _ __  
		${ORANGE}  | | / _ \ / __|| '_ \  | |_) || | | | / __|| '_ \ | || '_ \ 
		${ORANGE}  | ||  __/| (__ | | | | |  _ < | |_| || (__ | | | || || | | |
		${ORANGE}  |_| \___| \___||_| |_| |_| \_\ \__,_| \___||_| |_||_||_| |_|
		${ORANGE}                                            ${RED}Version : ${__version__}

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Ruchin Himasha (tahmid.rayat)${WHITE}
	EOF
}
